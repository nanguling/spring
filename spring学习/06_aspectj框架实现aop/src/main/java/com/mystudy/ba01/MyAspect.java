...
public class MyAspect {
     ...
     *          3.不会影响目标方法的执行
     */
    /*@Before(value = "execution(public void com.mystudy.ba01.SomeServiceImpl.doSome(String,Integer))")
    public void myBefore() {
        //切面要执行的功能代码
        System.out.println("前置通知，切面功能，在目标方法之前输出执行时间:"+new Date());
    }*/

    /*@Before(value = "execution(void com.mystudy.ba01.SomeServiceImpl.doSome(String,Integer))")
    public void myBefore() {
        //切面要执行的功能代码
     ...
     *      作用：可以在通知方法中获取方法执行时的信息，例如方法的名称，方法的实参
     *      如果切面功能中需要用到放啊的信息，就加入JoinPoint。
    ...
    public void myBefore(JoinPoint jp) {
        ...
        //获取方法的实参
        Object[] arrs = jp.getArgs();
        for (Object arr:arrs) {
            System.out.println("方法的参数=="+arr);
        }
        //切面要执行的功能代码
        System.out.println("2===前置通知，切面功能，在目标方法之前输出执行时间:"+new Date());
    }
